...
export function SignupPage() {
  ...
  const initialRole = (searchParams.get('role') === 'seller' ? 'seller' : 'buyer') as UserRole;
        ...
        <div className="max-w-md mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              {role === 'buyer'
                ? 'Sign up to browse properties and place bids.'
          ...
          <p className="text-center text-sm text-gray-500 mt-6">
            ...
            <Link
              to={`/login?role=${role}${nextPath ? `&next=${encodeURIComponent(nextPath)}` : ''}`}
